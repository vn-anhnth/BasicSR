# Omni-SR: Omni Aggregation Networks for Lightweight Image Super-Resolution (CVPR 2023)
# Official repository: https://github.com/Francis0625/Omni-SR
...
class OSAG(nn.Module):
    def __init__(self, channel_num=64, bias=True, block_num=4, **kwargs):
        ...
        for _ in range(block_num):
            temp_res = OSA_Block(channel_num, bias=bias, ffn_bias=ffn_bias, window_size=window_size, with_pe=pe)
...
class OmniSR(nn.Module):
    def __init__(self, num_in_ch=3, num_out_ch=3, num_feat=64, res_num=5, block_num=1,
                 upsampling=2, upscale=None, bias=True, window_size=8, pe=True, ffn_bias=False, **kwargs):
        super(OmniSR, self).__init__()

        up_scale = upscale if upscale is not None else upsampling
